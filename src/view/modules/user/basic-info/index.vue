/* * @Author: chensongbo * @Date: 2021-12-06 14:43:18 * @Last Modified by:
chensongbo * @Last Modified time: 2021-12-14 09:59:47 */
      ...
      vm.getOrientation(file, function(orientation) {
        ...
        reader.onload = function(evt) {
          ...
          vm.resetOrientation(base64, orientation, function(resultBase64) {
            vm.b64toBlob(resultBase64, function() {
             // vm.userInfo.avatarUrl = window.URL.createObjectURL(blob);
              //调用接口上传图片
              vm.$postFile("/oss/upload", file)
                .then(({ data }) => {
                  if (data) {
